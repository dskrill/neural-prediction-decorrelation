...
from chcochleagram import cochlear_filters, envelope_extraction, downsampling
...
cochleagram_1 = {'rep_type': 'cochleagram',
                 'rep_kwargs': {'signal_size':40000,
                                ...
                                'pad_factor':None,
                                'use_rfft':True,
                                'coch_filter_type': cochlear_filters.ERBCosFilters,
                                'coch_filter_kwargs': {
                                    'n':50,
                                    'low_lim':50,
                                    'high_lim':10000,
                                ...
                                'env_extraction_type': envelope_extraction.HilbertEnvelopeExtraction,
